...
if nav == 'About':
    st.image('CHD_image.png')
    if st.checkbox('Show Data'):
     st.table(data)
    st.markdown(
        '''**This model predicts wheather an individual is prone to 10 Year CHD or not.K-Nearest Neigbhours has been used to make this prediction.**
        '''
    )
